					...
					echo "<div class='container'>";
						echo "<div class='row d-flex align-items-center justify-content-center'>";
							echo "<div class='about-content col-lg-12'>";
								...
								echo"<p class='text-white link-nav'><a href='index.php'>Home </a>  <span class='lnr lnr-arrow-right'></span>  <a href='adminview.php'>Admin</a></p>";
							echo "</div>";											
						echo "</div>";
					echo "</div>";
				echo "</section>";
...
<!--Start of Order Bus Ticket Area -->
			 ...
			 if($r = mysqli_query($store,$query))
			{
				while($row = mysqli_fetch_array($r))
				{
					...
					echo"<td align = 'center'><a href='delete.php?delete={$row['Username']}'><font color = 'green'>Delete</a></font></td>";
